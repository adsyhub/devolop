#!/usr/bin/env python3
"""Generate comprehensive pedagogical explanations for 2017-2 EJU Math Course 2 (8 questions)."""
...
math_c2_sections = [
    ...
    },
    {
        ...
        "title": "大問II 問1：非斉次隣接2項間漸化式と等比数列への帰着",
        "points": [
    ...
    },
    {
        ...
        "title": "大問II 問2：二等辺三角形の直線方程式と内接円半径・頂点座標の決定",
        "points": [
    ...
    },
    {
        ...
        "title": "大問III 前半：対数不等式の同値変形と導関数の導出",
        "points": [
    ...
    },
    {
        ...
        "title": "大問III 後半：関数の増減表と最大値に基づく成立条件",
        "points": [
            "g'(x) の符号変化による増減表の作成",
            "区間における最大値の計算",
    ...
    },
    {
        ...
        "title": "大問IV 前半：媒介変数表示と三角方程式による2曲線の交点決定",
        "points": [
    ...
    },
    {
        ...
        "title": "大問IV 後半：置換積分と対数関数による囲まれた図形の面積計算",
        "points": [
...
def main():
    work_dir = Path("work/2017-2-math-c2")
    ...
    md_path = docs_dir / "2017-2-math-c2-solutions.md"
